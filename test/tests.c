...
/*   Updated: 2022/08/24 11:30:19 by mvieira-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Test(executer_handler, two_comands_without_infile)
{
	char **envp;
...
Test(executer_handler, tree_comands_without_infile)
{
...
Test(executer_handler, test4_tree_comands_with_infile)
{
	/* O output está correto, mas tem algum erro  */
	char **envp;
	envp = malloc(sizeof(char *) * 4);
